        ...
        {permisosFiltrados.length === 0 ? (
          ...
          permisosFiltrados.map(item => {
            ...
            return (
              <div
                key={item.id}
                className={`p-5 rounded-3xl border-2 transition-all duration-300 shadow-sm flex flex-col gap-4 ${
                  isPendiente 
                ...
                {isPendiente && (
                  <div className="pt-2 border-t border-slate-100 space-y-3">
                    ...
                    {!estaRechazando && (
                      <div className="flex flex-wrap items-center gap-2">
                        ...
                        <button
                          ...
                          disabled={isLoading}
                          className="flex-1 sm:flex-none flex items-center justify-center gap-2 px-5 py-2.5 rounded-xl bg-emerald-600 hover:bg-emerald-500 text-white text-xs font-bold shadow-md hover:shadow-lg transition-all active:scale-95 disabled:opacity-50"
                        >
                        ...
                        <button
                          ...
                          className="px-3.5 py-2.5 rounded-xl bg-emerald-50 hover:bg-emerald-100 text-emerald-800 border border-emerald-300 text-xs font-bold transition-all flex items-center gap-1.5"
                        ...
                        <button
                          ...
                          disabled={isLoading}
                          className="px-4 py-2.5 rounded-xl bg-rose-50 hover:bg-rose-100 text-rose-700 border border-rose-300 text-xs font-bold transition-all flex items-center gap-1.5 ml-auto active:scale-95"
                        >
                          <X className="w-4 h-4" />
                          <span>Rechazar</span>
                        </button>
                    ...
                    {menuAprobacionAbierto && (
                      <div className="p-4 rounded-2xl bg-emerald-50/80 border border-emerald-200 text-xs space-y-3 animate-fadeIn">
                        ...
                        <div className="flex flex-wrap gap-2">
                          {CONDICIONES_APROBACION.map(c => (
                            <button
                              ...
                              className="px-3 py-1.5 rounded-lg bg-white hover:bg-emerald-600 hover:text-white text-emerald-900 font-semibold border border-emerald-300 transition-colors text-xs text-left"
                            >
                              {c.label}
                            </button>
                          ))}
                        ...
                        <div className="pt-2 border-t border-emerald-200 flex gap-2">
                          <input
                            ...
                            className="flex-1 px-3 py-1.5 rounded-lg border border-emerald-300 text-xs bg-white text-slate-800 focus:ring-2 focus:ring-emerald-500"
                          />
                          <button
                            onClick={() => handleAprobarRapido(item, notaPersonalizada.trim())}
                            disabled={!notaPersonalizada.trim()}
                            className="px-3 py-1.5 rounded-lg bg-emerald-700 hover:bg-emerald-800 text-white font-bold text-xs disabled:opacity-40"
                          >
                            Aprobar
                          </button>
                        </div>
                    ...
                    {estaRechazando && (
                      <div className="p-4 rounded-2xl bg-rose-50 border border-rose-300 text-xs space-y-3 animate-fadeIn">
                        ...
                        <div className="flex flex-wrap gap-1.5">
                          {MOTIVOS_RECHAZO_SUGERIDOS.map(motivo => (
                            <button
                              ...
                              className="px-2.5 py-1 rounded-lg bg-white hover:bg-rose-100 text-rose-900 font-medium border border-rose-200 text-[11px] transition-colors"
                            >
                              {motivo}
                            </button>
                          ))}
                        ...
                        <textarea
                          ...
                          className="w-full px-3 py-2 rounded-xl border border-rose-300 text-xs text-slate-900 bg-white focus:ring-2 focus:ring-rose-500"
                        />
                        ...
                        <div className="flex items-center justify-end gap-2 pt-1">
                          <button
                            type="button"
                            onClick={() => setRechazandoId(null)}
                            className="px-3 py-1.5 rounded-lg text-slate-600 hover:bg-rose-100/50 font-semibold"
                          >
                            Cancelar
                          </button>
                          <button
                            ...
                            className="px-4 py-2 rounded-xl bg-rose-600 hover:bg-rose-700 text-white font-bold text-xs shadow-md disabled:opacity-40 flex items-center gap-1.5"
                          >
                ...
                {!isPendiente && (
                  <div className="pt-2 border-t border-slate-200/60 flex items-center justify-between flex-wrap gap-2">
                    <div className="flex items-center gap-2">
                      {isAprobado && (
                        <button
                          ...
                          className="flex items-center gap-1.5 px-3 py-1.5 rounded-xl bg-white hover:bg-slate-100 text-slate-800 text-xs font-semibold border border-slate-200 shadow-sm transition-all"
                        >
                    ...
                    <button
                      ...
                      disabled={isLoading}
                      className="flex items-center gap-1 px-3 py-1.5 rounded-xl text-xs font-semibold text-slate-500 hover:text-slate-800 hover:bg-slate-100 transition-all ml-auto"
